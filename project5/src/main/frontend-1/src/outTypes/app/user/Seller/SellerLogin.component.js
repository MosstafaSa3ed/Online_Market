...
var SellerLoginComponent = /** @class */ (function () {
    function SellerLoginComponent(_userservice, _route) {
        this._userservice = _userservice;
        this._route = _route;
        // this.user=this._userservice.getter();
    }
    SellerLoginComponent.prototype.processForm = function (value1, value2) {
        var _this = this;
        console.log("seller login");
        console.log(value1);
        console.log(value2);
        this._userservice.SellLogin(value1, value2).subscribe(function (user) {
            console.log(user);
            if (user == true) {
                console.log("mwgod");
                ...
                _this._route.navigate(['/sellerLogin']);
            }
        });
    };
...
exports.SellerLoginComponent = SellerLoginComponent;
//# sourceMappingURL=SellerLogin.component.js.map